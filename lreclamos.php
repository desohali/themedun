        ...
        <div class="ctn-contra" id='ctn-dos'>
            <form id="formReclamaciones" method="POST" class="form-contra" enctype="multipart/form-data">
                ...
                <div class="boxhc">
                    ...
                    <div class="divhisto" id="idcon">
                        <p><select name="documento" id="documento" required><option class="select-opt" value="">Documento de identidad</option><option value="DNI">DNI</option><option value="Carnet de extranjería">Carnet de extranjería</option><option value="Pasaporte">Pasaporte</option><option value="Permiso temporal de permanencia">Permiso temporal de permanencia</option></select></p>
                ...
                <div class="boxhc">
                    ...
                    <div class="divhisto" id="idcon">
                        <p><select name="documentotut"><option class="select-opt" value="">Documento de identidad</option><option value="DNI">DNI</option><option value="Carnet de extranjería">Carnet de extranjería</option><option value="Pasaporte">Pasaporte</option><option value="Permiso temporal de permanencia">Permiso temporal de permanencia</option></select></p>
                ...
                <div class="boxhc">
                    ...
                    <div class="divhisto" id="idbien2">
                        <p><select name="tipobien" id="tipobien" required><option class="select-opt" value="">Tipo de bien</option><option value="Producto">Producto</option><option value="Servicio">Servicio</option></select></p>
                    </div>
                ...
                <div class="boxhc">
                    ...
                    <div class="sobrehisto">
                    <div class="divhisto" id="idcon2">
                        <p class="espacio" id="preclamo"><select name="reclamo" id="reclamo" required><option class="select-opt" value="">Tipo de solicitud</option><option value="Queja">Queja</option><option value="Reclamo">Reclamo</option></select></p>
                    </div>
                    <div class="divhisto" id="idcon2">
                        ...
                        <script>function evilabel(valor){document.querySelector('#labelevi').innerText = valor;document.querySelector('#labelevi').style.color = 'black';
                        if(valor == ""){
