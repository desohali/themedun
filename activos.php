...
<head>
    ...
    <title>Médicos Activos - The Med Universe | Administrador</title>
...
<a href="https://api.whatsapp.com/send?phone=51986206045&text=Hola,%20tengo%20una%20consulta%20%C2%BFpueden%20ayudarme?%20%F0%9F%A4%94" target="_blank" class="btn-wsp"><i class="fa-brands fa-whatsapp"></i></a>
    ...
    <main>
        <div class="ctn-home" id="ctn-home">
	            ...
	            //Consulta SQL
	            $consultavistas ="SELECT * FROM usuariospro $where (estado='1' OR estado='2') ORDER BY idpro DESC LIMIT ".(($compag-1)*$CantidadMostrar)." , ".$CantidadMostrar;
            ...
            <div class="box-full">
                ...
                if($lista['estado'] == '2'){
                ?>
                <h2 id="nombreperfil" style="color:#ff0800"><a href='<?php echo $_ENV['APP_URL'];?>perfilrevision/<?php echo $lista["idpro"]; ?>' class="tituloadmin"><?php echo $doctor.' '.$lista['nombrespro'].' '.$lista['apellidospro']?></a></h2>
                <?php
                }else{
                ?>
