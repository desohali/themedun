        ...
        if (mysqli_stmt_num_rows($stmt) == 1) {
            ...
            if (mysqli_stmt_fetch($stmt)) {
                ...
                <body>
                    ...
                    <p>" . $estimado . ", " . $nombres . " " . $apellidos . ":<br><br>Hemos recibido una solicitud para restablecer tu contraseña de The Med Universe | Paciente. Para restablecer tu contraseña, ingresa el siguiente código: " . $codigo . "<br><br>Si no solicitaste una nueva contraseña, háznoslo saber a través de nuestro Centro de Ayuda: <a href='".$_ENV['APP_URL']."cayuda'>".$_ENV['APP_URL']."cayuda</a></p>
                </body>
                </html>
                ";
