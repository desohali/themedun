...
if ($urlactual == 'https://themeduniverse.com/recuperarc') {
    echo "<script>window.location.href='" . $_ENV['APP_URL'] . "recuperarc'</script>";
}
        ...
        window.addEventListener("DOMContentLoaded", function() {
            ...
            formEnviarCodigo.addEventListener("submit", async function(e) {
                ...
                if ($("#correo").val() != '') {
                    ...
                    fetch("<?php echo $_ENV['APP_URL']; ?>php/enviarCodigo.php", peticion)
