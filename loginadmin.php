...
if ($urlactual=='https://themeduniverse.com/loginadmin') {
    echo "<script>window.location.href='" . $_ENV['APP_URL'] . "loginadmin'</script>";
}
...
<head>
    ...
    <title>The Med Universe | Administrador</title>
...
<script>
    window.addEventListener("DOMContentLoaded", function(){
        ...
        formLoginAdmin.addEventListener("submit", async function(e){
            ...
            if($("#correo").val()!='' && $("#contraseña").val()!=''){
                ...
                fetch("<?php echo $_ENV['APP_URL'];?>php/validarLoginAdmin.php", peticion)
                            ...
                            Swal.fire({
                                ...
                                timerProgressBar: true,
                                    ...
                                    if(respuesta["estado"]=="1"){
                                        window.location.replace("<?php echo $_ENV['APP_URL'];?>activos");
                                    }else{
                                        window.location.replace("<?php echo $_ENV['APP_URL'];?>perfiladmin/"+respuesta["id"]);
                                    }
                                });
                        }
                    }
    ...
    <main>
        <div class="titulo__frase" id="fraseadmin">
            <h1 class="fraseadmin" id="frasecompleta">
                <pre><h1 class="fraseadmin" id="mu">The Med Universe |</h1> <h1 class="fraseadmin" id="px">Administrador</h1></pre>
            </h1>
        ...
        <div class="contenedor__todo" id="ctn_login_admin">
            <div class="caja__trasera" style="background:transparent">
            </div>

            <!--Formulario de Login y registro-->
            <div class="contenedor__login-register" id="contenedoradmin">

                <!--Login-->
                <form id="formLoginAdmin" action="" method="POST" class="formulario__login">
                    <h2>INICIE SESIÓN</h2>
                    ...
                    <a id="aolvidar" href="<?php echo $_ENV['APP_URL']; ?>recuperarcadmin">¿Olvidó su contraseña?</a>
                    <hr id="hr-login">
                    <div class="med-logos">
