...
if ($urlactual=='https://themeduniverse.com/restablecercadmin') {
    echo "<script>window.location.href='" . $_ENV['APP_URL'] . "restablecercadmin'</script>";
}
    ...
    window.addEventListener("DOMContentLoaded", function(){
        ...
        formComprobarCodigo.addEventListener("submit", async function(e){
            ...
            if($("#codigo").val()!=''){
                ...
                fetch("<?php echo $_ENV['APP_URL'];?>php/comprobarCodigoAdmin.php", peticion)
                    ...
                    if(respuesta["codigo"]=="Este codigo no existe"){
                        ...
                        Swal.fire({
                            ...
                            confirmButtonText: 'Ok',
                                ...
                                window.location.replace("<?php echo $_ENV['APP_URL'];?>cambiarcadmin/"+respuesta["id"]+"/"+respuesta["token"]+"/"+respuesta["codigo"]);
                            });
                    }
                })
            }
