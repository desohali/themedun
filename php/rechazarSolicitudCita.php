...
$query = "UPDATE citas SET estado = 'RECHAZADA', leido='NO', leidopro='NO', fechanoti=now() WHERE idcita='". $idcita . "'";
...
<body>
    ...
    <p>".$estimado.", ".$nombrespac." ".$apellidospac.":<br><br>Has recibido el rechazo de tu solicitud de cita ".$del." ".$nombrespro." ".$apellidospro." para el ".$tiempoFinal.". Para enviar una nueva solicitud de cita, selecciona otra fecha disponible en <a href='".$_ENV['APP_URL']."cita/".$idpro."'>".$_ENV['APP_URL']."cita/".$idpro."</a></p>
</body>
</html>
";
