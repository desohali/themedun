...
if ($urlactual=='https://themeduniverse.com/cambiarc') {
    echo "<script>window.location.href='" . $_ENV['APP_URL'] . "cambiarc'</script>";
}
        ...
        nueva_contra.addEventListener("submit", async function(e){
            ...
            if($("#contraseña").val()!='' && $("#contraseñac").val()!=''){
                if($("#contraseña").val()!=$("#contraseñac").val()){
                    ...
                    const response = fetch("<?php echo $_ENV['APP_URL'];?>php/cambiarContraseña.php", {
                        method: "post",
                        body: formData,
                    })
                    Swal.fire({
                        ...
                        confirmButtonText: 'Ok',
                            ...
                            window.location.replace("<?php echo $_ENV['APP_URL'];?>");
                        });
                }
            }
        });
