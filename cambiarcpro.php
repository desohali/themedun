...
if ($urlactual=='https://themeduniverse.com/cambiarcpro') {
    echo "<script>window.location.href='" . $_ENV['APP_URL'] . "cambiarcpro'</script>";
}
            ...
            nueva_contra.addEventListener("submit", async function(e) {
                ...
                if ($("#contraseña").val() != '' && $("#contraseñac").val() != '') {
                    if ($("#contraseña").val() != $("#contraseñac").val()) {
                        ...
                        const response = fetch("<?php echo $_ENV['APP_URL']; ?>php/cambiarContraseñaPro.php", {
                            method: "post",
                            body: formData,
                        })
                        Swal.fire({
                            ...
                            window.location.replace("<?php echo $_ENV['APP_URL']; ?>loginpro");
                        });
                    }
                }
            });
