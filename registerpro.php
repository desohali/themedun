...
<body>
    ...
    <main>
        <div class="titulo__frase">
            <h1 id="frasecompleta"><pre><h1 id="mu">The Med Universe |</h1> <h1 id="px">Profesional</h1></pre></h1>
        ...
        <div class="contenedor__todo">
            ...
            <div class="contenedor__login-register">
                ...
                <form id="formRegistrarMedico" method="POST" class="formulario__register" enctype="multipart/form-data">
                    ...
                    <a href="<?php echo $_ENV['APP_URL'];?>privacidad">Política de Privacidad</a> y la <a href="<?php echo $_ENV['APP_URL'];?>cookies">Política de Cookies</a>.</p>
